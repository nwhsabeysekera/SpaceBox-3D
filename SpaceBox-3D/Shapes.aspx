...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <asp:DropDownList ID="SelectShape" runat="server" BackColor="#3B3B3B"  ForeColor="#FFCB74" Height="60px" Width="200px" Font-Size="20px" style="border-radius: 5px;border-color:#E6A02D;">
